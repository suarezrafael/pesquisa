...
-- mesmo motivo do lab-163: o Worker nunca interpreta o conteúdo, só repassa pro perfil público de
-- quem tem permissão de ver (`house_visible`). `house_furniture_ids` guarda o array com
-- REPETIÇÃO (uma entrada por cópia possuída, mesmo formato de `Progress.unlockedFurnitureIds`) —
-- suficiente pra recalcular quantas cópias de cada item mostrar, sem precisar de um objeto
-- separado de contagem.
--
