...
- [ ] Corrigir vazamento de material/textura: `applyHat`/`applyGlasses`/`applyHairShape`/
...
- [ ] Corrigir vazamento de shadow caster: os mesmos 4 pontos chamam `shadowGenerator.addShadowCaster(mesh)`
...
- [ ] Investigar e corrigir qualquer caso concreto de "herda mesh errada"/"duplica"/"trava" além do
      ...
      Lab 176)
- [ ] Adicionar teste/regressão para troca sequencial de cosméticos (mesmo padrão de teste de
...
- [ ] Revisar limpeza de meshes/materiais/estado visual nos 4 pontos de disposal listados acima,
