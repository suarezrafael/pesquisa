...
- [ ] Som de passo mais audível (ganho maior, filtro mais grave).
- [ ] Canto de pássaro baixinho quando o jogador está perto (novo som sintetizado + gatilho por
      distância na IA de vagar dos pássaros já existente).
- [ ] Verificação: `npm run build` passa; testar tudo rodando o dev server (pulo com tempo no
