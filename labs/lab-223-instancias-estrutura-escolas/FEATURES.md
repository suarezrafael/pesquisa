...
- [x] Montar uma estrutura-fonte com paredes, fundacao e porta e instanciar suas folhas nas outras
  29 escolas (referencia: `labs/lab-222-instancias-professores-escolas/CONTEXT.md`).
- [x] Manter um `PhysicsAggregate` estatico independente em cada parede instanciada, validando o
  suporte explicito de `InstancedMesh` no Havok instalado (referencia: backlog 193).
- [x] Preservar materiais compartilhados, sombras, relevo, telhado dinamico, labels, professor e
  culling por escola (referencia: Labs 95, 206, 221 e 222).
- [x] Expor contagens de meshes-fonte/instancias da estrutura no HUD e no relatorio de performance.
- [x] Adicionar cobertura automatizada, medir contra o Lab 222 e validar TypeScript forcado, suite
