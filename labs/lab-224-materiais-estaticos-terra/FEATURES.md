...
- [x] Criar um helper testavel para congelar materiais estaticos uma unica vez e informar a
  contagem auditada (referencia: `labs/lab-223-instancias-estrutura-escolas/CONTEXT.md`).
- [x] Congelar uma primeira familia conservadora de materiais estaticos da Terra depois de toda a
  configuracao inicial, sem congelar materiais que mudam em runtime (referencia: backlog 193).
- [x] Manter uma lista explicita de exclusao para avatar, pets, telhados/portais de quest, agua,
  moedas, efeitos, puzzles e qualidade grafica dinamica.
- [x] Expor materiais totais/congelados no HUD e no relatorio `window.__perf`.
- [x] Adicionar cobertura automatizada e comparar o mesmo roteiro do Lab 223 no Edge, alem de
