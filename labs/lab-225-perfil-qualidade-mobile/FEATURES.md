...
- [ ] Reunir antialiasing, post-processamento, sombra, ambiente, densidade e efeitos num perfil
  tipado, preservando os valores atuais (referencia: Lab 224 `CONTEXT.md` e backlog 193).
- [ ] Substituir as decisoes dispersas em `World3D.tsx` pelo perfil, sem afetar legibilidade,
  conteudo educativo ou ajuste continuo de resolucao (referencia: Labs 59/67/70 e backlog 193).
- [ ] Expor o perfil e as reducoes ativas no HUD/`window.__perf.sample()` para coleta comparavel
  em Redmi Pad 2 e Poco C75 (referencia: Lab 219 e Lab 224 `CONTEXT.md`).
- [ ] Testar a paridade dos perfis e o fluxo real no Edge, alem de TypeScript, suite, lint e build
